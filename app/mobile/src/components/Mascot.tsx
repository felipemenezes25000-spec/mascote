/**
 * Mascote-robô paramétrico alinhado ao Design Handoff (RobotMascot).
 *
 * Mantém a API antiga (personality, phase, mood, accessory) pra não quebrar
 * as telas existentes, mas o visual passa a ser um robô laranja com:
